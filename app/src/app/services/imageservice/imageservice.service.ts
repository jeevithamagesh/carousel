...
export class imageserviceService {
    images = [
        ...
        },
        {
            ...
            imgPrice: "$ 1,125,000",
            imgDesc: "Beverly Hills, CA 90210",
            imgHeader: "Duis sollicitudin bibendum"

        },
        {
            imgSrc: "assets/Web/photo4.jpg",
            imgPrice: "$ 1,200,000",
            imgDesc: "132 04th St, San Francisco",
        ...
        },
        {
            ...
            imgPrice: "$ 1,185,000",
            imgDesc: "21120 Broadway St,Sann Fransisco",
            imgHeader: "Nullam finibus libero at hendrerit"
        }
    ];
